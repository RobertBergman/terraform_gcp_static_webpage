...
const SETTINGS_KEY = 'meal-planner-settings';
const MEAL_PLANS_KEY = 'meal-planner-meal-plans';
const RECIPE_LIBRARY_KEY = 'meal-planner-library';
const WEEKLY_CALENDAR_KEY = 'meal-planner-weekly-calendar';
const CURRENT_MEAL_PLAN_KEY = 'meal-planner-current-meal-plan';
