...
const UserInfo = () => {
  ...
  return (
    <div className="flex items-center gap-4 bg-gray-800/50 p-2 rounded-full">
      ...
      <Link href="/dashboard" className="bg-blue-500/20 text-blue-300 border border-blue-400/50 py-2 px-6 rounded-full font-semibold transition-all duration-300 hover:bg-blue-500/30 hover:border-blue-400/80">
        Dashboard
      </Link>
      <button
        onClick={() => signOut()}
